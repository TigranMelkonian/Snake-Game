...
public class GamePannel extends JPanel implements Runnable, KeyListener {
	...
	private Entity head, apple, boarder;
	...
	public void paint(Graphics mycanvas){
		...
		mycanvas.fillRect(0, 0, WIDTH -1, HEIGHT-1);
		mycanvas.setColor(Color.white);
		mycanvas.fillRect(20,20,WIDTH - 41, HEIGHT - 41);
	...
	public void render(Graphics2D g2d) {
		...
		apple.render(g2d);
		if (gameOver) {
			g2d.drawString("GAMEOVER!", 450, 500);
		}

		g2d.setColor(Color.WHITE);
		g2d.drawString("Score : " + score + " Level" + level, 10, 10);
		if (dx == 0 && dy == 0) {
			g2d.drawString("READY!", 450, 500);
		}
